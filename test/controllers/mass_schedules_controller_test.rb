...
class MassSchedulesControllerTest < ActionDispatch::IntegrationTest
      ...
      post church_mass_schedules_url(@church_without_mass_schedules), params: {
        mass_schedules: {
          schedules_attributes: {
            "0" => { day_of_week: 0, start_time: "08:00", active: true },
            "1" => { day_of_week: 1, start_time: "19:00", active: true }
          }
        }
      }
    end
  ...
  #   post church_mass_schedules_url(@church_with_mass_schedules), params: {
  #     mass_schedules: {
  #       schedules_attributes: {
  #         "0" => { day_of_week: 0, start_time: "08:00", active: true }
  #       }
